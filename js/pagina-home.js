...
async function iniciar() {
  console.log("[DEBUG] pagina-home: iniciar() começou");
  const user = await garantirLogin();
  console.log("[DEBUG] pagina-home: garantirLogin() retornou", user);
  const nomeSalvo = getNomeLocal();

  telaLoading.hidden = true;
  console.log("[DEBUG] pagina-home: tela de loading escondida");
